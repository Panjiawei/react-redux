...
import loginLightbox from "./app/loginLightbox";
import connect from "react-redux/es/connect/connect";
import  ReactDOM from "react-native";
import App from "./App";
import Provider from "react-redux/es/components/Provider";
import {store} from "./app/store/TestStore";
import serviceWorker from "react-native";
...
const scenes = Actions.create(
    ...
    <Lightbox>
    <Scene key="root">
        <Scene key="One" component={One} title="diyi"initial={true}/>
        <Scene key="Two" component={Two} title="dier"/>
        <Scene key="Three" component={Three} title="wode"/>
    </Scene>
