...
export default class loginLightbox extends Component {
    ...
    render() {
        return (
            <View style={{flexDirection:'column',borderTopColor:"#e0e0e0", marginTop:20}}>

            <View style={{width: 50, height: 50, backgroundColor: 'powderblue'}} />
                <View style={{width: 50, height: 50, backgroundColor: 'skyblue'}} />
                <View style={{width: 50, height: 50, backgroundColor: 'steelblue'}} />
                <Text style={{height:100,width:100}} onPress={()=>Actions.pop()}>确定</Text>
            </View>
        );
    }
}
